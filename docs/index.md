...
- [handoff.md](handoff.md) — **start here if you're a dev agent picking this up**: what's in flight, what's settled and shouldn't be relitigated, open work with the analysis already done, and the traps that cost real time
